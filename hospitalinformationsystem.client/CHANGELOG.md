...
- Create Angular project with ng: `ng new hospitalinformationsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`hospitalinformationsystem.client.esproj`).
